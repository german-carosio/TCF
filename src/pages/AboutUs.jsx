        ...
        <section className={styles.container}>
          <div className={styles.images}>
            ...
            <div className={styles.icon}>
              <img 
                src="/img/web/isologo1.png" 
                alt="isologo Todo con frijol" 
                loading="lazy" 
              />
            </div>
          </div>
          ...
          <div className={styles.txt}>
            <div className={styles.cabeceraTxt}>
              ...
              <img 
                src="/img/web/Logo2.svg" 
                alt="Logo Todo con frijol" 
                loading="lazy" 
              />
            </div>

            <p>El US Dry Bean Council (USDBC, por sus siglas en inglés) es una organización privada que representa agricultores, distribuidores y compañías que producen, manejan, exportan y procesan frijoles cultivados en los Estados Unidos.</p>
